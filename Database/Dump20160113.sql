...
--
-- Host: localhost    Database: pos_inventory_db
-- ------------------------------------------------------
...
INSERT INTO `inventory_tbl` VALUES (1,'SWGB1D1015M09','2015-10-15 15:29:45',100,100,'CCTVLand'),(2,'SWGB1D1015M09','2015-10-15 15:31:12',100,100,'SecuriLink'),(3,'CTVB1D1015M00','2015-10-15 15:31:50',100,100,'RovioSystems'),(4,'CTVB1D1015M00',NULL,NULL,-50,''),(5,'CTVB1D1015M00',NULL,NULL,-1,''),(6,'CTVB1D1015M00',NULL,NULL,-1,NULL),(7,'CTVB1D1015M00','2015-10-15 18:43:43',100,100,'CCTVLand'),(8,'ACCB1D1015M30','2015-10-15 18:45:46',100,100,'RovioSystems'),(9,'ACCB1D1015M30',NULL,NULL,-100,NULL),(10,'SWGB1D1015M09',NULL,NULL,-7,NULL),(11,'CTVB1D1015M00',NULL,NULL,-2,NULL),(12,'CTVB1D1015M00',NULL,NULL,-50,NULL),(13,'ACCB1D1015M30','2016-01-12 13:32:46',200,200,'RovioSystems'),(14,'accb1d1015m30','2016-01-12 15:50:51',100,100,'SecuriLink'),(15,'accb1d1015m30','2016-01-13 09:37:44',300,300,'SM');
...
INSERT INTO `product_tbl` VALUES ('ACCB1D1015M30','Mechanical Safety Edge',1,200.00,'Safety Safe Products','3 months','2 months'),('CTVB1D1015M00','ATD-18040',2,400.00,'At The Moment','2 months','3 months'),('SWGB1D1015M09','FLAP BARRIER GATE',1,200.00,'Flappy','2 months','2 months');
...
INSERT INTO `user_tbl` VALUES ('CJ','1000:0kvsVNGnZ7YHYCyvXMrJClQKCyM3h828:E6n/fB2//+RrY6GzaPn1PxEyMXyKRXfa','ADMIN','2015-09-06 01:36:36','','\0',1,'Dog'),('Francis','1000:cXsSfDJE5IpkCpPgsqZLjTAUbSUrwP3z:VdDAcu3dy/POkaLO9lo5S4HK5nvNpdJ7','STAFF','2015-09-13 11:02:09','','\0',1,'Dog'),('Jerwin','1000:gBMaS7CPoPuWssMx7Mp62asrgwOA92sS:upbW17soJuVdyFv6uhZC+s9Uif7nE+Gt','INVENTORY_PERSONNEL','2015-09-13 11:24:38','','\0',1,'Dog'),('jessea','1000:IV6vfxHd3+oZOpzhuvQqaWqKFWgnlxF7:QwX+pD/fdR9ceKrThIYMHoeiA3iBTlML','STAFF','2015-10-04 18:05:49','\0','\0',1,'Dog'),('Karen','1000:MC2hqaVscON7bSPVsrdlPXJk1L6crrFD:0WgLdA1IbCGI2Ky0qmfO+8MyYoLDi+PA','CASHIER','2015-09-17 09:40:51','','\0',1,'Dog'),('Rabi','1000:JQ7Krc6eL01CNWzahmeGl3cnE8UgfSDo:IVh/sn6SQvxcwn/qNRbxDMNcVAPobCib','ADMIN','2015-09-13 13:35:25','','\0',2,'Cat'),('Randy','1000:f4SEmab2lco1yQqFfOqN+w4oSy0shM2d:HaURFbRfMKDTUUseYyzvlRdPnuR9gaAa','STAFF','2015-09-13 10:52:08','','\0',1,'Dog');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`pos_user`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `product_inspection_view` AS select `inventory_view`.`Barcode` AS `Item_Code`,`inventory_view`.`Name` AS `Description`,`inventory_view`.`Category` AS `Category`,`inventory_view`.`Unit_price` AS `Unit_Price`,`product_tbl`.`specification` AS `Specification`,`product_tbl`.`warranty` AS `Warranty`,`product_tbl`.`replacement` AS `Replacement_Period`,`inventory_view`.`Qty_On_Hand` AS `Quantity_On_Hand` from (`product_tbl` join `inventory_view` on((`product_tbl`.`id` = `inventory_view`.`Barcode`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2016-01-13 16:29:57
